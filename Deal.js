            ...
            <View style={{flex: 1, backgroundColor: 'white'}}>
                <View style={{height: height(10), margin: width(3), marginBottom: 0}}>
                    <StepIndicator
                        ...
                        labels={["Thông tin cơ bản", "Vị trí", "Đăng bài"]}
                    />
                </View>
                {this.renderStep()}
            </View>
            ...
            return (
                <View style={styles.container}>
                            ...
                            <View style={{flex: 1}}>
                                <View style={{flexDirection: 'row', alignItems: 'center',}}>
                                    <Text style={{fontSize: 17, color: '#2c3e50', marginTop: 10,}}>
                                        {"Vị trí của tôi : " + this.state.place}</Text>
                                </View>
                            </View>
                        </View>
                    </View>
                    ...
                    <TouchableOpacity
                        ...
                        <View style={{alignItems: 'center', justifyContent: 'center'}}>
                            <Text style={{fontSize: 20, color: 'rgba(117,117,117 ,1)',}}>
                                {"Trở lại"}</Text>
                        </View>
                    </TouchableOpacity>
                </View>
                        ...
                        <View style={{position: 'absolute', justifyContent: 'center', alignItems: 'center'}}>
                            <View style={{flex: 3}}>
                                <Text style={{fontSize: 20, color: '#2c3e50', fontWeight: 'bold', marginTop: 20,}}>
                                    {(this.state.type === "Tất cả") ? "Loại đội cần tìm : Tất cả" : "Cần tìm đội : " + this.state.type + " người"}</Text>
                                <Text style={{fontSize: 20, color: '#2c3e50', marginTop: 20,}}>
                                    {"Độ tuổi : " + this.state.age}</Text>
                                <View style={{flexDirection: 'column'}}>
                                    <Text style={{fontSize: 20, color: '#2c3e50', marginTop: 20,}}>
                                        {"Thời gian :  " + this.state.date.getDay() + "/" + this.state.date.getMonth() + "/" + this.state.date.getFullYear()}</Text>
                            ...
                            <TouchableOpacity
                                ...
                                <View style={{flexDirection: 'row', justifyContent: 'center'}}>
                                    <FontAwesome size={25} name="newspaper-o" color="white"/>
                                    <Text style={{
                                        color: 'white',
                                        fontSize: 20,
                                    }}> Đăng bài</Text>
                            ...
                            <TouchableOpacity
                                ...
                                <View
                                    ...
                                    <FontAwesome size={22} name="refresh" color="white"/>
                                    <Text style={{
                                        color: 'white',
                                        fontSize: 18
                                    }}>{" Quay lại"}</Text>
